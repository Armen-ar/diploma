...
3. В приложении Core добавить 'urls.py' и в файле 'todolist/urls.py' включить urls из приложения Core.

4. Добавить файл 'serializers.py' в приложение Core и описать 'ModelSerializer' для регистрации, авторизации и 
обновления данных.

5. Описать View для регистрации, авторизации и обновления данных пользователя и добавить их в core/urls.py.
