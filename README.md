...
4. Добавить файл 'serializers.py' в приложение Core и описать 'ModelSerializer' для регистрации.

5. Описать View для регистрации пользователя и добавить его в core/urls.py.
